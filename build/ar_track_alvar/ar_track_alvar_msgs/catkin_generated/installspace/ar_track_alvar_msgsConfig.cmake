...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chengda/catkin_ws/install/${idir}'.  Ask the maintainer 'Scott Niekum <sniekum@cs.umass.edu>, Isaac I.Y. Saito <gm130s@gmail.com>' to fix it.")
    endif()
