...
class Num(genpy.Message):
  _md5sum = "3147036be9e5e3982849ca9e9faaf8bf"
...
string name
"""
  __slots__ = ['num','age','name']
  _slot_types = ['int64','uint8','string']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_qB().pack(_x.num, _x.age))
      _x = self.name
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.num, _x.age,) = _get_struct_qB().unpack(str[start:end])
      start = end
      end += 4
